module.exports = [
  {
    ...
    fExecute: dataModel => {
      ...
      if (channel === 'all') {
        dataModel.guild.announcements = dataModel.client.channels.cache.filter(c => c.guild.id === dataModel.message.guild.id && c.type === 'news').map(c => c.id);
        return 'Added every announcement channel.';
      }
      ...
      if (c && c.guild.id === dataModel.message.guild.id && c.type === 'news') {
        ...
        return 'Successfully added announcment channel <#' + channel + '>';
      } else {
    ...
    fExecute: dataModel => {
      ...
      if (channel === 'all') {
        ...
        return 'Removed every announcement channel.';
      }
      ...
      if (c && c.guild.id === dataModel.message.guild.id && c.type === 'news') {
        if (dataModel.guild.announcements.find(a => a === channel)) {
          ...
          return 'Successfully removed announcment channel <#' + channel + '>';
        } else {
